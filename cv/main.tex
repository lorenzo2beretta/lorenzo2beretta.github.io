...
\renewcommand{\section}{\@startsection{section}{1}{0pt}%
  ...
  {\normalfont\Large\bfseries\color{DarkGray}\sectionrule}}
\newcommand{\sectionrule}{\@ifnextchar[{\sectionrule@i}{\sectionrule@i[]}}
\def\sectionrule@i[#1]#2{#2\par\nobreak\vspace{0.3ex}\hrule height 0.8pt\relax}
...
\newcommand{\MyName}[1]{ % Name
		{\Huge\bfseries\color{black}\centering #1\par}\vspace{0.5em}}

\newcommand{\MyAffiliation}[1]{ % Affiliation
		{\large\color{black}\centering #1\par}\vspace{0.3em}}
...
Theory of algorithms, high-dimensional geometry, high-dimensional probability, sublinear algorithms, optimal transport.
...
\EducationEntry{Scuola Normale Superiore (Honors Program)}{
Over five years, I completed two extra years of coursework, earning the equivalent of a master’s in mathematics}{2015 -- 2020}{}
...
\begin{itemize}[leftmargin=0.5em,itemsep=0.3em]
\EducationEntry{Goldstine Fellow at IBM Research}{}{Sep 2025 -- present}{}
...
\EducationEntry{EU TALENT Doctoral Fellowship Grant}{I was granted  three-year PhD fellowship by the Horizon 2020 Marie Skłodowska-Curie program}{2020}{}
...
In theoretical computer science, authors are sorted alphabetically. All publications on this list follow this convention apart for C8, where the starred authors share first authorship as is customary in machine learning.

\subsection*{Preprints}
\begin{itemize}[leftmargin=0.5em,itemsep=0.3em]
\item \textbf{A Tight Analysis of Khatri-Rao Oblivious Subspace Embeddings}\\
Lorenzo Beretta, Cameron Musco \\
\url{https://arxiv.org/abs/2608.28094}
\end{itemize}
...
Marco Miani$^\star$, Lorenzo Beretta$^\star$, Søren Hauberg \\
...
Mikkel Abrahamsen, Ioana Bercea, Lorenzo Beretta, Jonas Klausen, László Kozma \\
...
Ioana Bercea, Lorenzo Beretta, Jakob Bæk Tejs Houen, Jonas Klausen, Mikkel Thorup \\
...
invited to HALG 2022 and TALG special issue} \hfill C2
...
\begin{itemize}[leftmargin=0.5em,itemsep=0.3em]
\EducationEntry{Conference PC}{ESA (2026)}{}{}
...
\begin{itemize}[leftmargin=0.5em,itemsep=0.3em]
\EducationEntry{Teaching Assistant, Copenhagen University}{I served twice as T.A. for the ``Randomized Algorithms'' graduate course at Copenhagen University}{2021 -- 2022}{}
